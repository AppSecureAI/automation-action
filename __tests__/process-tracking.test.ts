  ...
  describe('handles completed status', () => {
    ...
    it('shows PRs created for push stage', () => {
      expect(
        ...
        '✅ Pull Requests: Completed (5 PRs created, across 5 remediation units)'
      )
    })
    ...
    it('uses customer-visible PR count for push stage when summary provides it', () => {
      expect(
        ...
        '✅ Pull Requests: Completed (1 PR created, across 3 remediation units)'
      )
    })
  ...
  describe('handles in_progress status', () => {
    ...
    it('shows normal progress for push when remediation_loop is completed', () => {
      ...
      expect(
        ...
        '⏳ Pull Requests: 6 of ~8 created (2 remediation units remaining, 75%)'
      )
    })
...
describe('logProcessTracking', () => {
  ...
  it('logs push with normal format when remediation_loop is completed', () => {
    ...
    expect(calls).toContain(
      '[RUN_STATUS]: ⏳ Pull Requests: 6 of ~8 created (2 remediation units remaining, 75%)'
    )
  })
