...
| `CREATE_ISSUES_FOR_INCOMPLETE_REMEDIATIONS` | env   | Create GitHub Issues for findings that need more context instead of opening incomplete remediation PRs. | `false`         |
